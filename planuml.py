...
class planmuml_bin:
    def __init__(self) -> None:
        self.jarpath = os.path.join( os.path.dirname(__file__),"plantuml-1.2024.6.jar")
        self.java = where_is_bin("java")
        pass
    def conver(self,uml, format="png"):
...
def planuml_to_image(file):
    plamuml_jar.conver(file)